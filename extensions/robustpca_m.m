...
% 
% ROBUSTPCA_M returns the eigenvectors of a dataset computed using the Grassmann average technique. 
% This technique performs better scalability against the number of samples and the dimension of the 
% dataset. 
%
...
%
% - "nb_iterations_max": indicates the maximum number of iterations for each eigenvector that should
